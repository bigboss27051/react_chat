	...
	var App = (function (_Component) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function addMessage(msg) {
	            ...
	            messages.push({ id: messages.length, msg: msg });
	        ...
	        value: function render() {
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    'div',
	                    { className: 'nav' },
	                    _react2['default'].createElement(_channelsChannelSectionJsx2['default'], _extends({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Message = (function (_Component) {
	    ...
	    _createClass(Message, [{
	        key: 'render',
	        value: function render() {
	            var currentTime = _fecha2['default'].format(new Date(), 'HH:mm:ss YY-MM-DD');
	            return _react2['default'].createElement(
	                'li',
	                { className: 'message' },
	                _react2['default'].createElement(
